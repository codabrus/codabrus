...
**README.md в libs/ai-agents обновляется автоматически на CI.** Исходными файлами документации являются `.lisp`-файлы в `libs/ai-agents/docs/` (index.lisp, changelog.lisp). Не редактировать README.md вручную.
